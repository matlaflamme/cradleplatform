...
import com.cradlerest.web.util.datagen.ForeignKeyRepository;
 ...
 */
public class ForeignKeyRepositoryImpl implements ForeignKeyRepository {
	 ...
	 */
	@Override
	public Vec<Object> get(@NotNull Class<?> type) throws ForeignKeyException {
